...
<div id="wrapper">
        ...
        <ul>
            ...
            <%
                ...
                if (userVO != null){
                    ...
                    out.println("<li><a href=\"user-login.jsp\">SIGN UP</a></li>");
                }
            %>
        </ul>
    </div>
    ...
    <div id="sidebar">
        ...
        <div id="cart">
            <%--            <%--%>
            <%--                List<ProductVO> productVOList = (List<ProductVO>) request.getSession().getAttribute("homeViewProducts");--%>
            <%--               if (productVOList != null && !productVOList.isEmpty()){--%>
            <%--                   out.println(productVOList.get(0).getName());--%>
            <%--               }--%>
            <%--            %>--%>
